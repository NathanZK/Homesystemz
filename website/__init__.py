...
def create_app():
    ...
    app.config['SQLALCHEMY_DATABASE_URI'] =  'postgresql://wimfcmgzsgiogx:3461cbae475659dde38c8b4006ae945c27c81b62ae8b048897c9b372557357f0@ec2-34-200-35-222.compute-1.amazonaws.com:5432/dc229dg09ggml7'
    app.config['SECRET_KEY'] = 'KEY'
    db.init_app(app)
